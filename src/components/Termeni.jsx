    ...
    <>
      ...
      <section className="max-w-3xl mx-auto py-30 px-4 text-gray-800">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          ...
          <li>
            <strong>Monetizare:</strong> Site-ul poate afișa reclame prin Google AdSense și poate include linkuri afiliate. Donațiile sunt acceptate voluntar, fără obligativitate.
          </li>
          <li>
            <strong>Lipsa afilierii:</strong> Nu suntem asociați cu nicio companie producătoare sau distribuitoare a produsului Lipovon.
          </li>
          <li>
            <strong>Utilizarea conținutului:</strong> Conținutul este proprietatea StopLipovon.ro și nu poate fi copiat sau redistribuit fără acord.
          </li>
          <li>
          ...
          <li>
            <strong>Protecția datelor:</strong> Nu colectăm date personale fără consimțământ. Pentru mai multe detalii, citiți Politica de Confidențialitate.
          </li>
        </ol>
      </section>
    </>
