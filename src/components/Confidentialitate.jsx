  ...
  return (
    <>
      ...
      <section className="max-w-3xl mx-auto py-30 px-4 text-gray-800">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">1. Cookie-uri</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">2. Date colectate</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">3. Drepturile tale</h2>
        <p>
