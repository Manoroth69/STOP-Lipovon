...
export const HeroTest = () => {
  ...
  // useEffect removed since no isVisible needed
 ...
 const warningCards = [
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative w-full max-w-md mx-auto">
                ...
                {/* Warning Cards with staggered animation */}
                {warningCards.map((card, index) => {
  const cardType = card.type || "info"; // fallback to info
  return (
   <MotionA
  key={index}
  href={card.url}
  ...
  animate={{
    opacity: 1,
    scale: [1, 1.05, 1],  // pulse între 1 și 1.05
  }}
  transition={{
    delay: 1 + index * 0.5,
    duration: 3,       // durată lentă, 3 secunde per puls
    repeat: Infinity,
    ease: "easeInOut",
  }}
